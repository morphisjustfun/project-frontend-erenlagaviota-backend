        ...
        <WelcomeGrid>
          ...
          <div className="is-flex is-align-items-center">
            <WelcomeText className="has-text-justified">
              ...
              <StrongBlue> azul </StrongBlue>) permitirá desmarcar o marcar
              todas las demás cajas dependiendo del estado.
            </WelcomeText>
          </div>
          <div className="is-flex is-align-items-center">
            <WelcomeText className="has-text-justified">
          ...
          <div className="is-flex is-align-items-center">
            <WelcomeText className="has-text-justified">
              ...
              <strong>El selector de departamento </strong>le permitirá filtrar
              de acuerdo al departamento de su interés. Si selecciona
              "seleccionar", el filtro no tendrá efecto. <br />
              <strong>El recuadro de búsqueda </strong> le permitirá buscar por
              nombre o código. No se realiza una búsqueda exacta, sino por rango
              y aproximación. Si ingresa un valor con tildes o letras no
